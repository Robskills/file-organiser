...
# This handles cases where the script is run from inside the organisr_app folder
root_dir = Path(__file__).resolve().parent.parent
if str(root_dir) not in sys.path:
    sys.path.append(str(root_dir))

from organisr_app.actions import ActionExecutor
from organisr_app.ai_optimizer import AIOptimizer
from organisr_app.ai_service import LocalIntelligenceEngine
from organisr_app.config import DEST_DIR, DRY_RUN, SOURCE_DIRS
from organisr_app.deduplicator import Deduplicator
from organisr_app.domain_inference import DomainInference
from organisr_app.logger import setup_logging
from organisr_app.scanner import FileScanner
